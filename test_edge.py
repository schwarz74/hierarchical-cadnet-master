...
if __name__ == '__main__':
    ...
    learning_rate = 1e-2
    dropout_rate = 0.3
    checkpoint_path = "checkpoint/edge_lvl_6_units_512_epochs_100_date_2024-03-01.ckpt" #"checkpoint/MF_CAD++_residual_lvl_7_edge_MFCAD++_units_512_date_2021-07-27_epochs_100.ckpt"
    test_set_path = "data/test.h5"
